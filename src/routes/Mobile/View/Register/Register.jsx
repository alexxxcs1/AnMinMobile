    ...
    return <div className={[style.InformedConsent,'childcenter'].join(' ')}>
      <div className={[style.InformedConsentContent,'childcenter childcolumn'].join(' ')}>
        ...
        <div className={style.Content}>
          ...
          <p>我们将为您通过“真知灼见—全国CMPA膳食管理案例大赛”平台提供给我们的个人资料保密，但我们可能将您的资料披露给：（1）“真知灼见—全国CMPA膳食管理案例大赛”平台运作服务或意见的任何人员、代理、顾问、审计员、承包商或服务人员；（2）任何与中国医师协会儿科医师分会儿童消化专业委员会、《临床儿科杂志》有业务往来的关联机构及企业；（3）任何对我们负有保密责任的机构或人员；（4）根据中国或其他国家的法律法规，我们必须向其披露您的个人资料的机构或人员。</p> 
