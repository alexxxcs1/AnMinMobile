          ...
          <div className={[style.RuleBox,'childcenter childcolumn childcontentstart'].join(' ')}>
            ...
            <div className={style.RuleBottom}>
              <div className={[style.ButtonGroup,'childcenter'].join(' ')}>
                ...
                <div className={[style.Button,'childcenter childcolumn'].join(' ')} onClick={()=>{window.location.href = 'http://file.crnonline.org/%E7%89%9B%E5%A5%B6%E8%9B%8B%E7%99%BD%E8%BF%87%E6%95%8F%E8%AF%8A%E6%B2%BB%E6%A1%88%E4%BE%8B%E5%BE%81%E9%9B%86%28%E6%A8%A1%E6%9D%BF%EF%BC%89.pptx'}}>
                  <span>下载</span>
                  <span>案例</span>
                </div>
              </div>
