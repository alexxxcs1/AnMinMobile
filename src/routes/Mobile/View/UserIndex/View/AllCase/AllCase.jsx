...
createList(){
    ...
    for (let z = 0; z < this.state.data.length; z++) {
        ...
        <div className={[style.ButtonGroup,'childcenter','childcontentstart'].join(' ')}>
            <div className={[style.HandleButton,style.Colorful,'childcenter'].join(' ')}> <a href={this.state.data[z].filePath} download={this.state.data[z].filePath} target='blank'>查看案例</a></div>
